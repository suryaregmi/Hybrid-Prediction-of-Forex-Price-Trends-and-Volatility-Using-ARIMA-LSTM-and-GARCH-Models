...
# split aligned to report idea but keeps a validation slice inside train
TRAIN_RATIO = 0.80
TEST_RATIO = 0.20
...
# 3. ARIMA ANALYSIS
# ============================================================
# stationarity on subtrain close
...
# validation forecast with ARIMA
arima_val_pred = arima_subtrain_fit.forecast(steps=len(df_val))

# refit ARIMA on full training for later test forecasting
...
# residuals from ARIMA on full dataset using rolling-like fitted values approximation
...
# refit LSTM on full training -> test
...
# align ARIMA test forecast length to LSTM test length
...
# ============================================================
# align validation ARIMA with LSTM validation target length
...
# forecast conditional variance across test horizon
horizon = len(hybrid_test_pred)
